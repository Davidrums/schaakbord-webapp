/**
 * This file contains all necessary Angular controller definitions for 'frontend.pages.author' module.
 *
                        ...
                        AuthorModel
                            ...
                            .then(
                                function onSuccess(result) {
                                    ...
                                    $state.go('pages.author', {id: result.data.id});
                                }
                            );
                    };
                }
